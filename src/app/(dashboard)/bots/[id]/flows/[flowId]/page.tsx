...
export default async function FlowBuilderPage({ params }: { params: { id: string; flowId: string } }) {
  ...
  return (
    <>
      ...
      <form action={setFlowTrigger} className="flex flex-wrap items-end gap-3 border-b border-linea bg-tarjeta px-4 py-2.5 sm:px-6">
        ...
        <DisparadorSocial
          ...
          respuestaPublicaModo={(flowRow.respuesta_publica_modo as string) ?? null}
