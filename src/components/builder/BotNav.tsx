...
import { MessagesSquare, MessageCircleReply, Megaphone, FileText, Plug, Settings, Timer, ShoppingBag, ClipboardList, Palette, Sparkles, BookOpen, ChevronLeft } from "lucide-react";
...
const TAB_UI: Record<FeatureKey, { suffix: string; icon: any }> = {
  ...
  respuestas: { suffix: "/respuestas", icon: MessageCircleReply },
