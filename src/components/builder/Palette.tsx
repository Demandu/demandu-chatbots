...
import { NODE_META, PALETTE_ORDER, type NodeType } from "@/lib/flow/types";

/** Paleta de componentes. Arrastra un bloque al lienzo. */
export function Palette() {
  ...
  return (
    <div className="w-[230px] overflow-auto border-r border-surface-border bg-surface p-4">
      ...
      <p className="mb-3.5 text-xs text-muted-2">Arrastra un bloque al lienzo</p>
