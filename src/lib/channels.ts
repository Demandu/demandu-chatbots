...
export type FeatureKey =
  ...
  | "respuestas"   // Respuestas automáticas (pantalla simple) — Instagram y Messenger
...
export const FEATURES: {
  ...
  // ── LA PANTALLA SIMPLE ─────────────────────────────────────────────────
  // Todo esto ya se podía configurar dentro de cada flujo, en una barra gris
  // que casi nadie mira. Configurable no es lo mismo que visible: para saber
  // «¿mi chatbot contesta los comentarios?» había que abrirlos uno a uno.
  //
  // Va donde hay comentarios e historias que contestar. En WhatsApp y en el
  // widget solo existe el mensaje directo, que ya es lo que hace el chatbot.
  { key: "respuestas", label: "Respuestas automáticas", channels: ["instagram", "messenger"] },
